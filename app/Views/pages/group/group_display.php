                            ...
                            <div class="flex flex-col p-5 border-b border-mainGray hover:bg-mainGray/5 transition-colors">
                                ...
                                <?php if (!empty($d['media_url'])): ?>
                                    <div class="rounded-2xl overflow-hidden border border-mainGray bg-black/5">
                                        <img src="<?= htmlspecialchars($d['media_url']) ?>"
                            ...
                            <?php if ($m['id'] == $group['owner_id']): ?>
                                <div class="flex items-center justify-between p-3 rounded-xl hover:bg-mainGray/5 transition-colors">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-12 h-12 rounded-full bg-gray-700 overflow-hidden relative border-2 border-yellow-500">
                                            <img src="https://i.pinimg.com/736x/0b/07/50/0b0750a69b4812b8bc68688808d38e40.jpg" class="w-full h-full object-cover">
                                        </div>
                                        <div>
                                    ...
                                    <span
                                        class="text-xs font-bold text-yellow-500 bg-yellow-500/10 px-3 py-1 rounded-full">Owner</span>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="space-y-1">
                        <?php foreach ($members as $m): ?>
                            <?php if ($m['id'] != $group['owner_id']): ?>
                                ...
                                <div
                                    class="flex items-center justify-between p-3 rounded-xl hover:bg-mainGray/5 transition-colors group">

                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-full bg-gray-700 overflow-hidden">
                                            <img src="https://i.pinimg.com/1200x/8d/e5/84/8de5841f06b0eefb417b54634ac7b8d2.jpg" class="w-full h-full object-cover">
                                        </div>
                                        <div>
