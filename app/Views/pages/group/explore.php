...
<div class="min-h-screen pt-20 pb-24 md:pl-20 md:pt-4 transition-colors duration-300"
    ...
    <div class="max-w-2xl mx-auto px-4">
        ...
        <div class="flex p-1 rounded-full mb-8 relative"
             style="background-color: var(--secondBg);">
            
            <div id="tab-slider" class="absolute left-1 top-1 bottom-1 w-[49%] rounded-full transition-all duration-300 z-0 shadow-sm"
        ...
        <div id="section-groups" class="animate-fade-in">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-2 pr-4 rounded-full transition-all hover:brightness-110"
                    ...
                    <button class="px-6 py-2 rounded-full font-bold text-sm transition-transform active:scale-95 text-white"
        ...
        <div id="section-users" class="hidden animate-fade-in">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-2 pr-4 rounded-full transition-all hover:brightness-110"
                    ...
                    <button class="px-6 py-2 rounded-full font-bold text-sm border transition-transform active:scale-95"
